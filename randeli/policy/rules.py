...
class Rules:
    ...
    def loadRulesFromDict(self, cfg):
        ...
        try:
            ...
            if 'policy.strong_font_size_rule' in cfg:
                self.strong_font_size_rule = float(cfg["policy.strong_font_size_rule"])
        except:
            pass
    ...
    def saveRulesToDict(self, cfg):
        ...
        try:
            ...
            cfg["policy"]["strong_font_size_rule"] = self.strong_font_size_rule
    ...
    def getStrongFontSize(self, size):
        self.logger.debug(f"Setting (strong) Font size to be {size} + {self.strong_font_size_rule}")
        return size + self.strong_font_size_rule
