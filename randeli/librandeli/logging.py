...
def setup_extended_log_levels():

    add_logging_level('TRACE', logging.DEBUG - 5, 'trace', KEEP_WARN)
    add_logging_level('DETAIL', logging.DEBUG + 5, 'detail', KEEP_WARN)
    add_logging_level('NOTICE', logging.INFO + 5, 'notice', KEEP_WARN)

# this is pulled from 
#   https://gitlab.com/madphysicist/haggis/-/blob/master/src/haggis/logs.py?ref_type=heads
#
# -*- coding: utf-8 -*-
