...
that uses a different font technology in the PDF (CID vs Type1)
...
has been commited that uses OCR to augment the document bypassing the use
...
The directory `samples` includes both input PDFs and the augmented versions of the inputs.
